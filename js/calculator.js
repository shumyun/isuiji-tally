...
/**
 * bug：有输入法时按键不能在计算器上显示并且出现在input框
 * update(by shumyun)：
 * 	2011.11.09： 修改了键盘输入不能匹配相应的字符按键
 */
...
$.extend(Calculator.prototype, {
        ...
        standardLayout: ['_1_2_3_+BS', '_4_5_6_-CE', '_7_8_9_*CA', '_0_._=_/', '@X  @U'],
...
jQuery(document).ready(function($) { 
	...
	$.calculator.setDefaults($.calculator.regional['zh-CN']);
